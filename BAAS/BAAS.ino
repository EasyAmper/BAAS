//    BAAS - Bell Automatic Activation System     
//    скетч для проекта BAAS/УАПЗ
//    разработан для платы NodeMcu/ Lolin (ESP8266)
//    разработал: EASYAMPER
...
const char *ssid     = "ASUS111";  // ваша сеть
const char *password = "Vas";    // пароль
